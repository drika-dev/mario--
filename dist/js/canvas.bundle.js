...
var GenericObjetct = /*#__PURE__*/function () {
  function GenericObjetct(_ref2) {
    var x = _ref2.x,
        y = _ref2.y,
        image = _ref2.image;

    _classCallCheck(this, GenericObjetct);
...
var genericobjects = [new GenericObjetct({
  x: -1,
  y: -1,
...
function animate() {
  ...
  if (keys.right.pressed && player.position.x < 400) {
    ...
    player.velocity.x = 0; //Plataforma - quando o personagem se move
